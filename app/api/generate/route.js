...
const systemPrompt = `
    ...
    Rule: When possible, provide brief explanations or additional context for the answers to reinforce learning. 
    Rule: Ensure that questions are unique and avoid repeating the same information across multiple flashcards. 
    Rule: Regularly update the flashcard database to include new information, correct outdated content, and refine question quality. 
    Rule: Allow users to customize their flashcard sets based on their learning preferences or specific areas of interest. 
